...
signale = {
    ...
    ["A"]    = {x = 9,  y = 10, richtung = "r",
        ...
        stelle_ers = {pc = "signale", au = "top",   fb = 0},
    },
    ["AA"]   = {x = 9,  y = 8,  richtung = "r",
        stelle_hp  = {pc = "signale", au = "right", fb = 1},
        stelle_ers = {pc = "signale", au = "top",   fb = 1},
    },
    ["B"]    = {x = 16, y = 4,  richtung = "r",
        stelle_hp  = {pc = "signale", au = "right", fb = 2},
        stelle_ers = {pc = "signale", au = "top",   fb = 2},
    },
    ["F"]    = {x = 66, y = 8,  richtung = "l",
        stelle_hp  = {pc = "signale", au = "right", fb = 3},
        stelle_ers = {pc = "signale", au = "top",   fb = 3},
    },
    ["FF"]   = {x = 66, y = 10, richtung = "l",
        stelle_hp  = {pc = "signale", au = "right", fb = 4},
        stelle_ers = {pc = "signale", au = "top",   fb = 4},
    },
    ["G"]    = {x = 62, y = 2,  richtung = "l",
        stelle_hp  = {pc = "signale", au = "right", fb = 5},
        stelle_ers = {pc = "signale", au = "top",   fb = 5},
    },
    ["N1"]   = {x = 44, y = 12, richtung = "r",
        stelle_hp  = {pc = "signale", au = "right", fb = 7},
        stelle_sh  = {pc = "signale", au = "left",  fb = 7},
        stelle_ers = {pc = "signale", au = "top",   fb = 7},
    },
    ["N2"]   = {x = 44, y = 10, richtung = "r",
        stelle_hp  = {pc = "signale", au = "right", fb = 8},
        stelle_sh  = {pc = "signale", au = "left",  fb = 8},
        stelle_ers = {pc = "signale", au = "top",   fb = 8},
    },
    ["N4"]   = {x = 44, y = 6,  richtung = "r",
        stelle_hp  = {pc = "signale", au = "right", fb = 9},
        stelle_sh  = {pc = "signale", au = "left",  fb = 9},
        stelle_ers = {pc = "signale", au = "top",   fb = 9},
    },
    ["N5-6"] = {x = 55, y = 2,  richtung = "r",
        stelle_hp  = {pc = "signale", au = "right", fb = 10},
        stelle_sh  = {pc = "signale", au = "left",  fb = 10},
        stelle_ers = {pc = "signale", au = "top",   fb = 10},
    },
    ["P1"]   = {x = 31, y = 12, richtung = "l",
        stelle_hp  = {pc = "signale", au = "right", fb = 11},
        stelle_sh  = {pc = "signale", au = "left",  fb = 11};
        stelle_ers = {pc = "signale", au = "top",   fb = 11},
    },
    ["P3"]   = {x = 31, y = 8,  richtung = "l",
        stelle_hp  = {pc = "signale", au = "right", fb = 12},
        stelle_sh  = {pc = "signale", au = "left",  fb = 12},
        stelle_ers = {pc = "signale", au = "top",   fb = 12},
    },
    ["P4"]   = {x = 31, y = 6,  richtung = "l",
        stelle_hp  = {pc = "signale", au = "right", fb = 13},
        stelle_sh  = {pc = "signale", au = "left",  fb = 13},
        stelle_ers = {pc = "signale", au = "top",   fb = 13},
    },
    ["P5"]   = {x = 31, y = 4,  richtung = "l",
        stelle_hp  = {pc = "signale", au = "right", fb = 14},
        stelle_sh  = {pc = "signale", au = "left",  fb = 14},
        stelle_ers = {pc = "signale", au = "top",   fb = 14},
    },
    ["P6"]   = {x = 31, y = 2,  richtung = "l",
        stelle_hp  = {pc = "signale", au = "right", fb = 15},
        stelle_sh  = {pc = "signale", au = "left",  fb = 15},
        stelle_ers = {pc = "signale", au = "top",   fb = 15},
    },
	
	-- Sperrsignale
    ["L003X"] = {x = 45,  y = 08, richtung = "r",
        stelle_sh = {pc = "signale", au = "left", fb = 0},
    },
    ["L005X"] = {x = 45,  y = 04, richtung = "r",
        stelle_sh = {pc = "signale", au = "left", fb = 1},
    },
    ["L006X"] = {x = 45,  y = 02, richtung = "r",
        stelle_sh = {pc = "signale", au = "left", fb = 2},
    },
    ["L012X"] = {x = 16,  y = 10, richtung = "r",
        stelle_sh = {pc = "signale", au = "left", fb = 3},
    },
    ["L013X"] = {x = 16,  y = 08, richtung = "r",
        stelle_sh = {pc = "signale", au = "left", fb = 4},
    },
    ["L002Y"] = {x = 31,  y = 10, richtung = "l",
        stelle_sh = {pc = "signale", au = "left", fb = 5},
    },
    ["L022Y"] = {x = 60,  y = 10, richtung = "l",
        stelle_sh = {pc = "signale", au = "left", fb = 6},
    },
}
